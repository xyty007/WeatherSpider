    ...
    with open(file_path, 'ab') as f:
        ...
        for origin_location, result in r_list:
            if result['result']['status'] == "ok":
                ...
                row_data = origin_location + [result['location'][1], result['location'][0], result['result']['skycon'],
...
def update_weather():
    t2 = threading.Timer(update_time_cycle, update_weather)
    t2.start()
...
if __name__ == '__main__':
    ...
    t = threading.Timer(update_time_cycle, update_weather)
    t.start()
